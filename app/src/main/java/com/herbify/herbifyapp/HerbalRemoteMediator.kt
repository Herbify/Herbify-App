...
class HerbalRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            val responseData = apiService.getAllHerbals(page, state.config.pageSize)
